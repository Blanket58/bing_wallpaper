...
if(!("RCurl" %in% packages)) install.packages("RCurl",repos="https://mirrors.tuna.tsinghua.edu.cn/CRAN/")
if(!("XML" %in% packages)) install.packages("XML",repos="https://mirrors.tuna.tsinghua.edu.cn/CRAN/")
if(!("stringr" %in% packages)) install.packages("stringr",repos="https://mirrors.tuna.tsinghua.edu.cn/CRAN/")
library(RCurl)
library(XML)
library(stringr)
